...
| [google-chat-patch-2026-04-09](./google-chat-patch-2026-04-09.md) | Emergency fix for OpenClaw 2026.4.8 Google Chat webhook 401 errors | openclaw, googlechat, patch, security, fleet-rollout | 2026-04-09 |
...
| Page | Summary | Tags | Updated |
|------|---------|------|---------|
| [punclaw-dashboard](./summaries/punclaw-dashboard.md) | Centralized fleet management platform for OpenClaw VMs (Next.js 16, SQLite, SSH proxy) | fleet-management, openclaw, dashboard, punclaw, sqlite | 2026-04-07 |
...
**Stats:** 2 sources | 8 concept pages | Last updated: 2026-04-13